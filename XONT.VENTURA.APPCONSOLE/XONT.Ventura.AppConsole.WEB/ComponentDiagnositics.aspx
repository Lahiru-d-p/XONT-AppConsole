<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComponentDiagnositics.aspx.cs" Inherits="XONT.Ventura.AppConsole.ComponentDiagnositics" %>
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="leftContent">
                    ...
                    <div runat="server" id="clientLibWrapper" visible="false">
                ...
                <div runat="server" id="div2ndLayerLibs" class="rightContent">
                    ...
                    <div class="gridWrapper">
                        <asp:GridView ID="grvRelatedLibraries" runat="server" AutoGenerateColumns="False" BackColor="White"
                            BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" AllowPaging="false"
                            CellPadding="2" CssClass="Gridtablestyle3" OnRowDataBound="grvRelatedLibraries_RowDataBound"
                            EmptyDataText="No data found for the given criteria" EmptyDataRowStyle-CssClass="Labelstyle"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderStyle-CssClass="GridPadding" DataField="version"
                                    HeaderText="Site Version" SortExpression="version">
                                    <HeaderStyle CssClass="GridPadding" />
                                </asp:BoundField>
                                <asp:BoundField HeaderStyle-CssClass="GridPadding" DataField="builtWithVersion"
                                    HeaderText="Built With" SortExpression="builtWithVersion">
                                    <HeaderStyle CssClass="GridPadding" />
                                </asp:BoundField>
                                <asp:BoundField HeaderStyle-CssClass="GridPadding" DataField="BuildDate" DataFormatString="{0:d}"
                                    HeaderText="Build Date" SortExpression="BuildDate">
                    ...
                    <cc3:GridExports ID="GridExports5" runat="server"
                        GrvHeader="Other XONT Libraries" AssociateGridID="grvXontOtherLibs" />

                    <div class="gridWrapper">
                        <asp:GridView ID="grvXontOtherLibs" runat="server" AutoGenerateColumns="False" BackColor="White"
                            BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" AllowPaging="false"
                            CellPadding="2" CssClass="Gridtablestyle5"
                            EmptyDataText="No data found for the given criteria" EmptyDataRowStyle-CssClass="Labelstyle"
                            AllowSorting="True" OnSorting="grvXontOtherLibs_Sorting">
                            <RowStyle ForeColor="#000066" />
                            <Columns>
                                <asp:BoundField HeaderStyle-CssClass="GridPadding" DataField="name"
                                    HeaderText="Name" SortExpression="name">
