...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //    PageMethods.RemoveActiveTaskInfo("");//V2049
        //});
    </script>
...
<body class="ovh" onbeforeunload="HandleClose();" onload="autoCSS();" style="-ms-overflow-y: hidden;">
    ...
    <div>	
        ...
        <!-- Maximum tab exceeded modal -->
        <div id="activeTask_tab" class="modalDialog2 fade in" style="display: none; position: relative; height: 100%;">
            <div>
                <div class="s-content" style="height: 175px; width: 500px;">
                    <div class="s-header" style="padding: 5px !important;">
                        <h4 class="s-title" style="font-weight: bold;">Alert!</h4>
                    ...
                    <div class="s-body">
                        <div class="bootbox-body" style="color: #000; margin-top: 5px; margin-bottom: 5px;"></div>
                    </div>
                    <div class="s-footer">
                        <a class="btn btn-primary" id="activeTask_ok" style="float: right; margin-top: 10px; margin-right: 10px;">OK</a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <li class="current">
                                                ...
                                                <div class="description" style="width: 60%;">
                                                    ...
                                                    <p style="margin-top: 20px;">
                                                        X-ONT VENTURA solution is an enterprise-wide application that addresses the Sales and Distribution requirements of distribution companies’ operation.
