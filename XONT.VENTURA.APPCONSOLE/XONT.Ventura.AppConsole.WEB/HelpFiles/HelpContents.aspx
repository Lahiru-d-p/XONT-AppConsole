...
<table cellpadding="0" cellspacing="0" style=" height: 500px">
			<tr>
				<td valign="top" class="style1">
                    ...
                    <asp:XmlDataSource ID="xmlHelpContent" runat="server" DataFile="../HelpFiles/help.xml">
                    </asp:XmlDataSource>
                </td>
				<td valign="middle" align="center" >				
				<iframe id="fraPage" runat="server" style="height: 100%; width:679px;border:none;" 
                        class="Textboxstyle" >
				</iframe>
				</td>
			</tr>
