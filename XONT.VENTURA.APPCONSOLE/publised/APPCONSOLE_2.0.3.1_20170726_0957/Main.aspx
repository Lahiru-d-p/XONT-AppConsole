                ...
                <div class="navbar">
                    ...
                    <nav id="top-nav" class="navbar-no-collapse" role="navigation">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li style="float: right;" onclick="openNav()">
                    ...
                    <div class="container" style="font-size: 10px !important; width: 100%; display: none; padding-left: 0; padding-right: 0;">
                        <div id="wrapper" style="width: 100%;">
                            <div style="float: left">
                                ...
                                <a href="#" id="minimizeTabs" style="font-size: 19px; margin-top: -12px; display: none" class="btn" title="Minimize"><i class="fa fa-minus-square"></i></a></div>
