    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div>
                    <asp:Label ID="lblClientDateFormat" Style="color: #006699;" runat="server" CssClass="Captionstyle" Text="Client Date Format : "></asp:Label>
                    <asp:Label ID="lblClientDateValue" runat="server" CssClass="Captionstyle"></asp:Label>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
