...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        //VR043Adding start
        function customerImgError() {
            $('#customerImgWrapper').hide();
    ...
    <style>
        ...
        #customerImgWrapper {
            ...
            #customerImgWrapper > span {
                color: #fff;
                font-weight: 500;
                font-size: 18px;
            }

        #spanSalesForceCaption {
            color: #fff;
            font-weight: 500;
            font-size: 21px;
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="logo wow fadeInDown" style="margin: 5% 0 11% 0;">
                                ...
                                <span id="spanSalesForceCaption">| Sales Force Automation</span>
                            </div>
                        ...
                        <div class="col-md-5" style="margin-top: 4%">
                            ...
                            <div class="signup-header wow fadeInUp">
                                <%--V2043Adding start--%>
                                <div id="customerImgWrapper">
                                    <%--<span> Licensed to  : </span>--%>
                                    <img alt="customer logo" src="images/customerLogo.png" onerror="customerImgError()" />
                                </div>
                                <%--V2043Adding end--%>
