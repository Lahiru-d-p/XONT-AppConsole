...
Sales Force Automation and an integrated redistribution Management Information System (MIS). 
                    ...
                    <div class="container" style="font-size: 10px !important; width: 100%; display: none; padding-left: 0; padding-right: 0;">
                        <div id="wrapper" style="width: 100%;">
                            <div style="float: left">
                                <ul id="crumb" style="font-size: 14px; padding-left: 10px; color: #166f95; font-weight: bold;"></ul>
                                <a href="#" id="minimizeTabs" style="font-size: 19px; margin-top: -12px; display: none" class="btn" title="Minimize"><i class="fa fa-minus-square"></i></a>
                            </div>
