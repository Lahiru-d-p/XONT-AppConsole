...
$(function () {
    ...
    myHub.client.newVisit = function (page, referrer, city, country, chatWith, connectionId, userId) {
        var d = new Date();
    ...
    myHub.client.newChat = function (id) {
        ...
        $('#chat-sessions').prepend(
            ...
            '<div class="col-md-12" style="width:95%;background:rgba(24, 166, 137, 0.28);color:white;"><abbr style="border:none;" class="timeago" title="' + d.toISOString() + '">' + d.toISOString() + '</abbr></div>' +
            '<div class="col-md-12" style="width:95%;background:rgba(24, 166, 137, 0.28);color:black;padding-right:0;"><a class="close-chat btn btn-mini" style="float:right;margin-top:-5px;" href="#"><span class="glyphicon glyphicon-remove"></span></a>' +
