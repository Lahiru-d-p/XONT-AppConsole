				...
				<div style="position:relative;width:98%;float:right;margin-top:10px;">
					...
					<ul  id="hello">
						<li id="li1" class="gs-w bg-blue " data-row="1" data-col="1" data-sizex="1" data-sizey="1">
							<i style="color:#fff;margin:auto;position:absolute;top:20%;left:0;right:0;font-size:50px;" class="im-question" title="Help"></i><span class="widget_text">Help</span></li>
...
<div id="wrapper" style="width:100%;">
   ...
   --%>
    ...
    <!-- Help modal -->
 <div id="help_Modal" class="modalDialog2 fade in" style="display:none;position:fixed;height:100%;width:100%;margin:auto;top:0;left:0;right:0;bottom:0;z-index:1000;">
	<div>	
		<div class="s-content" style="height:90%;width:80%;">
		<div class="s-header">
			<h4 class="s-title" style="font-weight:bold;"> Help Menu </h4>
                	<a style="font-size:20px;float:right;text-decoration:none;cursor:pointer;" class="fa fa-close" id="help_close"></a></div>
