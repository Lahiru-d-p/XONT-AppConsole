...
<body>
    <form id="form1" runat="server">
        ...
        <div class="fullscreen landing parallax" style="background-image: url('images/i10.jpg');" data-img-width="2000" data-img-height="1500" data-diff="100">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <!-- /.logo -->
                            <div class="logo wow fadeInDown" style="margin: 5% 0 11% 0;">
                                <a href="">
                                    <img src="images/logo-v.png" alt="logo"></a>
                            </div>

                            <!-- /.main title -->
                            <h1 class="wow fadeInLeft">Welcome to Ventura CRM
                            </h1>

                            <!-- /.header paragraph -->
                            <div class="landing-text wow fadeInUp">
                                <p>
                                    A highly productive sales force has an enormous impact on your company's top and bottom line. Yet today's salesperson faces more challenges than ever before fierce competition, dynamic deals and demanding customers. That's why better sales force automation (SFA) is critical to your success.
                                </p>
                                <p>
                                    By choosing Ventura software industry solution, you can reap the many benefits of SFA. Ventura system goes beyond simple Prospect management offered by other vendors to provide true, end-to-end customer management. With Ventura sales force automation software, you can streamline your sales cycles, close more deals, and better serve your customers.
                                </p>
                            </div>

                            <!-- /.header button -->
                            <div class="head-btn wow fadeInLeft">
                                <a href="#feature" class="btn-default">Read More</a>
                            ...
                            <div class="signup-header wow fadeInUp">
                                ...
                                <form class="form-header" action="" role="form" method="POST" id="#">
                                    <div class="form-group">
                                        <asp:TextBox ID="txtUserName" name="MERGE1" runat="server" CssClass="form-control input-lg" TabIndex="1" required></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="MERGE0" id="txtPassword" onchange="javascript:SetFocus('btnLoginButton')" runat="server" class="form-control input-lg" tabindex="2" required />
                                    </div>
                                    ...
                                    <div class="form-group last">
                                        <asp:Button ID="btnLoginButton" runat="server" CommandName="Login" ValidationGroup="Login1" Text="LOGIN" OnClick="btnLoginButton_Click" CssClass="btn btn-block btn-lg" TabIndex="4"  />
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                        ...
                                        ForeColor="#E50505"></asp:RequiredFieldValidator>--%> 
                                            ...
                                            <asp:RegularExpressionValidator ID="revUserName" runat="server" ControlToValidate="txtUserName" CssClass="Errormessagetextstyle" Display="Dynamic" ValidationExpression="^[^(')]*$"></asp:RegularExpressionValidator>
                                    </div>
